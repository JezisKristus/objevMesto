...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Úte 07. dub 2026, 12:16
...
INSERT INTO `comments` (`id`, `place_id`, `author_name`, `text`, `created_at`) VALUES
(1, 1, 'Jan Špalek', 'Bylo to good', '2026-04-07 12:00:15'),
...
INSERT INTO `places` (`id`, `city_id`, `type`, `name`, `description`, `address`, `image_url`) VALUES
(1, 1, 'Památka', 'Orloj', 'Lorem Ipsum', 'Praha 1, ', NULL),
...
INSERT INTO `ratings` (`id`, `place_id`, `stars`) VALUES
(1, 1, 3),
(2, 1, 5),
(3, 1, 3),
(4, 1, 4),
